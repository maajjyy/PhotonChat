package com.maajjyy.photon.Adapters;
...
import com.maajjyy.photon.Activities.ChatActivity;
import com.maajjyy.photon.Models.Message;
import com.maajjyy.photon.R;
import com.maajjyy.photon.databinding.DeleteDialogBinding;
import com.maajjyy.photon.databinding.ItemReceiveBinding;
import com.maajjyy.photon.databinding.ItemSentBinding;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ReactionPopup popup = new ReactionPopup(context, config, (pos) -> {
            if(holder.getClass() == SentViewHolder.class) {
                ...
                viewHolder.binding.feeling.setImageResource(reactions[0]);
